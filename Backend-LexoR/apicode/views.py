...
def isSolved(request, uid, pid):
    ...
    # """
    # AI-powered suggestions for problem-solving or code generation.
    # """

    
    # def post(self, request):
    #     """
    #     Expects `prompt` in the request body for generating suggestions.
    #     Example:
    #     {
    #         "prompt": "Explain the quicksort algorithm."
    #     }
    #     """
    #     client = openai(api_key="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")
